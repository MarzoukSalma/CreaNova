...
Creanova est une application complète de productivité et de développement personnel qui vous accompagne dans la réalisation de vos objectifs et rêves. Alliant organisation, motivation et intelligence artificielle, Creanova crée un environnement propice à la concrétisation de vos projets les plus ambitieux.

---

> 🚀 **Version  finale disponible sur la branche `main`**
